...
# zip
cd $DIR/../bin/Release/net6.0/win-x64; zip -r ../../win-x64.zip . -i wwwroot/* MeeKaraoke.exe
cd $DIR/../bin/Release/net6.0/linux-x64; zip -r ../../linux-x64.zip . -i wwwroot/* MeeKaraoke
cd $DIR/../bin/Release/net6.0/osx-x64; zip -r ../../osx-x64.zip . -i wwwroot/* MeeKaraoke
