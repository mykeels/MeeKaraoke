...
cd $DIR/../bin/Release/net6.0/win-x64-self-con; zip -r ../../win-x64-self-contained.zip . -i wwwroot/* MeeKaraoke.exe
cd $DIR/../bin/Release/net6.0/osx-x64-self-con; zip -r ../../osx-x64-self-contained.zip . -i wwwroot/* MeeKaraoke